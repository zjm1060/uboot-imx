...
static int setup_fec(int fec_id)
{
	...
	gpio_request(IMX_GPIO_NR(2, 1), "fec power en");
	/* Reset PHY */
...
static void setup_wl1831(void)
{
	...
	gpio_request(IMX_GPIO_NR(2, 12), "WiFi enable");
	gpio_request(IMX_GPIO_NR(2, 17), "Bt enable");
